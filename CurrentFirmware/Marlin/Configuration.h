...
#define STRING_CONFIG_H_AUTHOR "@benjaming" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_HEIGHT 290.3             // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 139 }  // default steps per unit for Kossel (bontech extruder)
...
//// CS: 2022-06-20-1 (aborted)
// #define Z_MAX_POS ((MANUAL_Z_HOME_POS) - 20.0)
////
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
